...
extern "C" {
    ...
    pub fn FcCharSetIsSubset(a: *const FcCharSet, b: *const FcCharSet)
     -> FcBool;
    pub fn FcCharSetFirstPage(a: *const FcCharSet, map: [FcChar32; 8],
                              next: *mut FcChar32) -> FcChar32;
    pub fn FcCharSetNextPage(a: *const FcCharSet, map: [FcChar32; 8],
                             next: *mut FcChar32) -> FcChar32;
   ...
   /* pub fn FcDirCacheLoadFile(cache_file: *const FcChar8,
    ...
    pub fn FcUtf8Len(string: *const FcChar8, len: ::libc::c_int,
     ...
     -> FcBool;
    pub fn FcUcs4ToUtf8(ucs4: FcChar32, dest: [FcChar8; 6])
     -> ::libc::c_int;
